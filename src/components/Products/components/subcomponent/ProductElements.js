                ...
                <Col xs={2} sm={12} className="product-element-container">
                    ...
                    onMouseLeave={this.decreaseOpacity}>
                        <ul>
                            ...
                            <li className="eng"><span className="product-text">Description: </span> {this.props.engDescription}</li>
                            <li><span className="product-text">Wymiary/Dimension: </span> {this.props.dimension}</li>
                            <li><span className="product-text">Waga/Weight: </span> {this.props.nettoWeight}</li>
